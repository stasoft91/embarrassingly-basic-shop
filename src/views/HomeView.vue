<template>
  ...
  <section class="mb-8" id="categories">
    <h2 class="text-2xl font-bold mb-2">Categories</h2>
      <div class="flex flex-wrap flex-row gap-4">
        ...
        >
          <img :src="category.thumbnailUrl" :alt="category.alt?.main" class="w-24 h-24 object-cover rounded-full mb-2">
  ...
  <section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      ...
      >
        <img :src="product.thumbnailUrl" :alt="product.name" class="w-32 h-32 object-contain mb-2">
...
export default defineComponent({
  ...
  setup() {
    ...
    const loadPage = async () => {
      ...
      const selectedCategory = categories.value.items.find((category) => {
